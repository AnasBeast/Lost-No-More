...
const Footer = () => {
    const footerNavigation = {
        ...
        social: [
          {
            name: 'Facebook',
            href: 'https://www.facebook.com/anasboussehmine',
            icon: (props) => (
          ...
          {
            name: 'Instagram',
            href: 'https://www.instagram.com/anas_boussehmine/?hl=en',
            icon: (props) => (
              <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                <path
                  fillRule="evenodd"
          ...
          {
            name: 'Twitter',
            href: 'https://twitter.com/anasboussehmine',
            icon: (props) => (
              <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          ...
          {
            name: 'GitHub',
            href: 'https://github.com/AnasBeast',
            icon: (props) => (
              <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                <path
                  fillRule="evenodd"
